...
class TripLogContentAdapter (
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TripLogContentAdapter.ViewHolder {
        return TripLogContentAdapter.ViewHolder(
            LayoutInflater
                .from(parent.context)
    ...
    override fun onBindViewHolder(holder: TripLogContentAdapter.ViewHolder, position: Int) {
