...
//        _tripLogList.value = tripLogReadUseCase.getTripLogs(TRIP_LOG_COUNT)
    ...
    private fun testList(): List<TripEntity> {
        ...
        list.add(TripEntity(id = 1, name = "즐거운 가족여행", startDate = Date(), endDate = Date(), image = ""))
        list.add(TripEntity(id = 2, name = "제주도 푸른밤", startDate = Date(), endDate = Date(), image = ""))
        list.add(TripEntity(id = 3, name = "경주 여행", startDate = Date(), endDate = Date(), image = ""))
        list.add(TripEntity(id = 4, name = "환장의 나라 에버랜드로", startDate = Date(), endDate = Date(), image = ""))
        list.add(TripEntity(id = 5, name = "이건 몇자까지 보일까 테스트용으로 만듦", startDate = Date(), endDate = Date(), image = ""))
        list.add(TripEntity(id = 6, name = "방콕", startDate = Date(), endDate = Date(), image = ""))
        list.add(TripEntity(id = 7, name = "군산 철길마을", startDate = Date(), endDate = Date(), image = ""))
